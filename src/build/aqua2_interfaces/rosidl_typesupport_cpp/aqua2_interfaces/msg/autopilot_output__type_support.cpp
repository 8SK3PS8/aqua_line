...
static const _AutopilotOutput_type_support_symbol_names_t _AutopilotOutput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, msg, AutopilotOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, msg, AutopilotOutput)),
  }
};
...
{
  return &::aqua2_interfaces::msg::rosidl_typesupport_cpp::AutopilotOutput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, msg, AutopilotOutput)() {
  return get_message_type_support_handle<aqua2_interfaces::msg::AutopilotOutput>();
}
