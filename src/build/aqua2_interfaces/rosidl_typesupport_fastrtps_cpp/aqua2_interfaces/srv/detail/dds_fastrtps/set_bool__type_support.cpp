...
#include "aqua2_interfaces/srv/detail/set_bool__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aqua2_interfaces::srv::SetBool_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aqua2_interfaces::srv::SetBool_Request & ros_message)
{
  // Member: value
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const aqua2_interfaces::srv::SetBool_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aqua2_interfaces::srv::SetBool_Request *>(
    untyped_ros_message);
...
{
  return &aqua2_interfaces::srv::typesupport_fastrtps_cpp::_SetBool_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, SetBool_Request)() {
  return &aqua2_interfaces::srv::typesupport_fastrtps_cpp::_SetBool_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aqua2_interfaces
cdr_serialize(
  const aqua2_interfaces::srv::SetBool_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: msg
  cdr << ros_message.msg;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aqua2_interfaces::srv::SetBool_Response & ros_message)
{
  // Member: msg
  cdr >> ros_message.msg;
...
{
  auto typed_message =
    static_cast<const aqua2_interfaces::srv::SetBool_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aqua2_interfaces::srv::SetBool_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &aqua2_interfaces::srv::typesupport_fastrtps_cpp::_SetBool_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, SetBool_Response)() {
  return &aqua2_interfaces::srv::typesupport_fastrtps_cpp::_SetBool_Response__handle;
}
...
{
  return &aqua2_interfaces::srv::typesupport_fastrtps_cpp::_SetBool__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, SetBool)() {
  return &aqua2_interfaces::srv::typesupport_fastrtps_cpp::_SetBool__handle;
}
