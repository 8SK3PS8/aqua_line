...
#include "aqua2_interfaces/msg/detail/autopilot_targets__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aqua2_interfaces::msg::AutopilotTargets & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aqua2_interfaces::msg::AutopilotTargets & ros_message)
{
  // Member: depth_target
  cdr >> ros_message.depth_target;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aqua2_interfaces
max_serialized_size_AutopilotTargets(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const aqua2_interfaces::msg::AutopilotTargets *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aqua2_interfaces::msg::AutopilotTargets *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AutopilotTargets__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aqua2_interfaces::msg::AutopilotTargets *>(
...
{
  return max_serialized_size_AutopilotTargets(full_bounded, 0);
}

static message_type_support_callbacks_t _AutopilotTargets__callbacks = {
...
static rosidl_message_type_support_t _AutopilotTargets__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AutopilotTargets__callbacks,
...
{
  return &aqua2_interfaces::msg::typesupport_fastrtps_cpp::_AutopilotTargets__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, msg, AutopilotTargets)() {
  return &aqua2_interfaces::msg::typesupport_fastrtps_cpp::_AutopilotTargets__handle;
}
