...
class Metaclass_GetBool(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aqua2_interfaces.srv import _get_bool
...
class GetBool(metaclass=Metaclass_GetBool):
    from aqua2_interfaces.srv._get_bool import GetBool_Request as Request
    from aqua2_interfaces.srv._get_bool import GetBool_Response as Response
