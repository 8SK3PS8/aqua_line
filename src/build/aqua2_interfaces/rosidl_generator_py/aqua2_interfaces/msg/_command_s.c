...
bool aqua2_interfaces__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aqua2_interfaces.msg._command.Command", full_classname_dest, 37) == 0);
  }
  aqua2_interfaces__msg__Command * ros_message = _ros_message;
  {  // speed
...
PyObject * aqua2_interfaces__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aqua2_interfaces.msg._command");
