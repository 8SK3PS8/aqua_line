...
#include <stddef.h>
#include "aqua2_interfaces/msg/detail/health__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  aqua2_interfaces__msg__Health__init(message_memory);
}

void Health__rosidl_typesupport_introspection_c__Health_fini_function(void * message_memory)
{
  aqua2_interfaces__msg__Health__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Health__rosidl_typesupport_introspection_c__Health_message_member_array[9] = {
  {
    "header",  // name
    ...
    offsetof(aqua2_interfaces__msg__Health, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, voltage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, current),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, avgvoltage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, avgcurrent),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, avgpower),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, battery_dod),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, mdbtemp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__msg__Health, leg_temps),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Health__rosidl_typesupport_introspection_c__Health_message_members = {
  ...
  "Health",  // message name
  9,  // number of fields
  sizeof(aqua2_interfaces__msg__Health),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_interfaces, msg, Health)() {
  Health__rosidl_typesupport_introspection_c__Health_message_member_array[0].members_ =
