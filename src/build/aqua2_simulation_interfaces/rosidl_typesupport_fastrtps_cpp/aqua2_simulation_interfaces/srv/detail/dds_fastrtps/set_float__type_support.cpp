...
#include "aqua2_simulation_interfaces/srv/detail/set_float__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aqua2_simulation_interfaces::srv::SetFloat_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aqua2_simulation_interfaces::srv::SetFloat_Request & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
...
{
  auto typed_message =
    static_cast<const aqua2_simulation_interfaces::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aqua2_simulation_interfaces::srv::SetFloat_Request *>(
    untyped_ros_message);
...
{
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_SetFloat_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_simulation_interfaces, srv, SetFloat_Request)() {
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_SetFloat_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aqua2_simulation_interfaces
cdr_serialize(
  const aqua2_simulation_interfaces::srv::SetFloat_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: msg
  cdr << ros_message.msg;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aqua2_simulation_interfaces::srv::SetFloat_Response & ros_message)
{
  // Member: msg
  cdr >> ros_message.msg;
...
{
  auto typed_message =
    static_cast<const aqua2_simulation_interfaces::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aqua2_simulation_interfaces::srv::SetFloat_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_SetFloat_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_simulation_interfaces, srv, SetFloat_Response)() {
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_SetFloat_Response__handle;
}
...
{
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_SetFloat__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_simulation_interfaces, srv, SetFloat)() {
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_SetFloat__handle;
}
