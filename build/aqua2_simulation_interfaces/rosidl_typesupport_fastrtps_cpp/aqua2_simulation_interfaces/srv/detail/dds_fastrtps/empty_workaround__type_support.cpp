...
#include "aqua2_simulation_interfaces/srv/detail/empty_workaround__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const aqua2_simulation_interfaces::srv::EmptyWorkaround_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aqua2_simulation_interfaces::srv::EmptyWorkaround_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EmptyWorkaround_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aqua2_simulation_interfaces::srv::EmptyWorkaround_Request *>(
...
{
  return max_serialized_size_EmptyWorkaround_Request(full_bounded, 0);
}

static message_type_support_callbacks_t _EmptyWorkaround_Request__callbacks = {
...
static rosidl_message_type_support_t _EmptyWorkaround_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EmptyWorkaround_Request__callbacks,
...
{
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_EmptyWorkaround_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const aqua2_simulation_interfaces::srv::EmptyWorkaround_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aqua2_simulation_interfaces::srv::EmptyWorkaround_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EmptyWorkaround_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aqua2_simulation_interfaces::srv::EmptyWorkaround_Response *>(
...
{
  return max_serialized_size_EmptyWorkaround_Response(full_bounded, 0);
}

static message_type_support_callbacks_t _EmptyWorkaround_Response__callbacks = {
  "aqua2_simulation_interfaces::srv",
...
static rosidl_message_type_support_t _EmptyWorkaround_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EmptyWorkaround_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_EmptyWorkaround_Response__handle;
}
...
static service_type_support_callbacks_t _EmptyWorkaround__callbacks = {
  "aqua2_simulation_interfaces::srv",
  "EmptyWorkaround",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_simulation_interfaces, srv, EmptyWorkaround_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_simulation_interfaces, srv, EmptyWorkaround_Response)(),
...
static rosidl_service_type_support_t _EmptyWorkaround__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EmptyWorkaround__callbacks,
...
{
  return &aqua2_simulation_interfaces::srv::typesupport_fastrtps_cpp::_EmptyWorkaround__handle;
}
