...
static const _SetLegStatus_Request_type_support_symbol_names_t _SetLegStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aqua2_simulation_interfaces, srv, SetLegStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_simulation_interfaces, srv, SetLegStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aqua2_simulation_interfaces, srv, SetLegStatus_Request)() {
  return &::aqua2_simulation_interfaces::srv::rosidl_typesupport_c::SetLegStatus_Request_message_type_support_handle;
}
...
static const _SetLegStatus_Response_type_support_symbol_names_t _SetLegStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aqua2_simulation_interfaces, srv, SetLegStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_simulation_interfaces, srv, SetLegStatus_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_aqua2_simulation_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aqua2_simulation_interfaces, srv, SetLegStatus_Response)() {
  return &::aqua2_simulation_interfaces::srv::rosidl_typesupport_c::SetLegStatus_Response_message_type_support_handle;
}
...
static const _SetLegStatus_type_support_symbol_names_t _SetLegStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aqua2_simulation_interfaces, srv, SetLegStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_simulation_interfaces, srv, SetLegStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aqua2_simulation_interfaces, srv, SetLegStatus)() {
  return &::aqua2_simulation_interfaces::srv::rosidl_typesupport_c::SetLegStatus_service_type_support_handle;
}
