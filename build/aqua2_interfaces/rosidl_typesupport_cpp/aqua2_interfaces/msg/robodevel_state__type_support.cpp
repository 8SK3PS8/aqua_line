...
static const _RobodevelState_type_support_symbol_names_t _RobodevelState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, msg, RobodevelState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, msg, RobodevelState)),
  }
};
...
{
  return &::aqua2_interfaces::msg::rosidl_typesupport_cpp::RobodevelState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, msg, RobodevelState)() {
  return get_message_type_support_handle<aqua2_interfaces::msg::RobodevelState>();
}
