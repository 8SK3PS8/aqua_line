...
static const _GetBool_Request_type_support_symbol_names_t _GetBool_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, GetBool_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, srv, GetBool_Request)),
  }
};
...
{
  return &::aqua2_interfaces::srv::rosidl_typesupport_cpp::GetBool_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, srv, GetBool_Request)() {
  return get_message_type_support_handle<aqua2_interfaces::srv::GetBool_Request>();
}
...
static const _GetBool_Response_type_support_symbol_names_t _GetBool_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, GetBool_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, srv, GetBool_Response)),
  }
};
...
{
  return &::aqua2_interfaces::srv::rosidl_typesupport_cpp::GetBool_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, srv, GetBool_Response)() {
  return get_message_type_support_handle<aqua2_interfaces::srv::GetBool_Response>();
}
...
static const _GetBool_type_support_symbol_names_t _GetBool_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, GetBool)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, srv, GetBool)),
  }
};
...
{
  return &::aqua2_interfaces::srv::rosidl_typesupport_cpp::GetBool_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, srv, GetBool)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<aqua2_interfaces::srv::GetBool>();
}
