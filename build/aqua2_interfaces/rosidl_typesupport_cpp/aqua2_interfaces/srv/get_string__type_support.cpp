...
static const _GetString_Request_type_support_symbol_names_t _GetString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, GetString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, srv, GetString_Request)),
  }
};
...
{
  return &::aqua2_interfaces::srv::rosidl_typesupport_cpp::GetString_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, srv, GetString_Request)() {
  return get_message_type_support_handle<aqua2_interfaces::srv::GetString_Request>();
}
...
static const _GetString_Response_type_support_symbol_names_t _GetString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, GetString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, srv, GetString_Response)),
  }
};
...
{
  return &::aqua2_interfaces::srv::rosidl_typesupport_cpp::GetString_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, srv, GetString_Response)() {
  return get_message_type_support_handle<aqua2_interfaces::srv::GetString_Response>();
}
...
static const _GetString_type_support_symbol_names_t _GetString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aqua2_interfaces, srv, GetString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aqua2_interfaces, srv, GetString)),
  }
};
...
{
  return &::aqua2_interfaces::srv::rosidl_typesupport_cpp::GetString_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, aqua2_interfaces, srv, GetString)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<aqua2_interfaces::srv::GetString>();
}
