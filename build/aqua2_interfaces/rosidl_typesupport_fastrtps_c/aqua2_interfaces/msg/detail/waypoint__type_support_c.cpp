...
#include "aqua2_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoint__ros_msg_type = aqua2_interfaces__msg__Waypoint;
...
size_t get_serialized_size_aqua2_interfaces__msg__Waypoint(
  const void * untyped_ros_message,
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aqua2_interfaces__msg__Waypoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aqua2_interfaces
size_t max_serialized_size_aqua2_interfaces__msg__Waypoint(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_aqua2_interfaces__msg__Waypoint(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aqua2_interfaces, msg, Waypoint)() {
