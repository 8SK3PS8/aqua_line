#!/usr/bin/env python3
#A lot of this is Ben's Code - whether slightly modified or not

import time
from .geometry import euler_from_quaternion
import rclpy
...
def calibrate(node):
    ...
    def check_calibration():
        ...
        future = client.call_async(request)
        node.get_logger().info("Here 1")
        rclpy.spin_until_future_complete(node, future)
        node.get_logger().info("Here 2")
