...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aqua2_simulation_interfaces.srv.GetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aqua2_simulation_interfaces.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from aqua2_simulation_interfaces.srv._get_position import GetPosition_Request as Request
    from aqua2_simulation_interfaces.srv._get_position import GetPosition_Response as Response
