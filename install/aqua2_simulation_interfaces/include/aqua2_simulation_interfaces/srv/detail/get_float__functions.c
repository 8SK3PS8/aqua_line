...
aqua2_simulation_interfaces__srv__GetFloat_Request__create()
{
  ...
  aqua2_simulation_interfaces__srv__GetFloat_Request * msg = (aqua2_simulation_interfaces__srv__GetFloat_Request *)allocator.allocate(sizeof(aqua2_simulation_interfaces__srv__GetFloat_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aqua2_simulation_interfaces__srv__GetFloat_Request));
  bool success = aqua2_simulation_interfaces__srv__GetFloat_Request__init(msg);
  if (!success) {
...
aqua2_simulation_interfaces__srv__GetFloat_Request__destroy(aqua2_simulation_interfaces__srv__GetFloat_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aqua2_simulation_interfaces__srv__GetFloat_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence__init(aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aqua2_simulation_interfaces__srv__GetFloat_Request * data = NULL;

  if (size) {
    data = (aqua2_simulation_interfaces__srv__GetFloat_Request *)allocator.zero_allocate(size, sizeof(aqua2_simulation_interfaces__srv__GetFloat_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = aqua2_simulation_interfaces__srv__GetFloat_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        aqua2_simulation_interfaces__srv__GetFloat_Request__fini(&data[i - 1]);
      }
...
aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence__fini(aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aqua2_simulation_interfaces__srv__GetFloat_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence * array = (aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence *)allocator.allocate(sizeof(aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence__init(array, size);
  if (!success) {
...
aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence__destroy(aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence__are_equal(const aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence * lhs, const aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aqua2_simulation_interfaces__srv__GetFloat_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  aqua2_simulation_interfaces__srv__GetFloat_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(aqua2_simulation_interfaces__srv__GetFloat_Request);
    aqua2_simulation_interfaces__srv__GetFloat_Request * data =
      (aqua2_simulation_interfaces__srv__GetFloat_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aqua2_simulation_interfaces__srv__GetFloat_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          aqua2_simulation_interfaces__srv__GetFloat_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!aqua2_simulation_interfaces__srv__GetFloat_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aqua2_simulation_interfaces__srv__GetFloat_Response * msg = (aqua2_simulation_interfaces__srv__GetFloat_Response *)allocator.allocate(sizeof(aqua2_simulation_interfaces__srv__GetFloat_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aqua2_simulation_interfaces__srv__GetFloat_Response));
  bool success = aqua2_simulation_interfaces__srv__GetFloat_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
aqua2_simulation_interfaces__srv__GetFloat_Response__destroy(aqua2_simulation_interfaces__srv__GetFloat_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aqua2_simulation_interfaces__srv__GetFloat_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence__init(aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aqua2_simulation_interfaces__srv__GetFloat_Response * data = NULL;

  if (size) {
    data = (aqua2_simulation_interfaces__srv__GetFloat_Response *)allocator.zero_allocate(size, sizeof(aqua2_simulation_interfaces__srv__GetFloat_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = aqua2_simulation_interfaces__srv__GetFloat_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        aqua2_simulation_interfaces__srv__GetFloat_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence__fini(aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      aqua2_simulation_interfaces__srv__GetFloat_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence * array = (aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence *)allocator.allocate(sizeof(aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence__destroy(aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence__are_equal(const aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence * lhs, const aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aqua2_simulation_interfaces__srv__GetFloat_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  aqua2_simulation_interfaces__srv__GetFloat_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(aqua2_simulation_interfaces__srv__GetFloat_Response);
    aqua2_simulation_interfaces__srv__GetFloat_Response * data =
      (aqua2_simulation_interfaces__srv__GetFloat_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aqua2_simulation_interfaces__srv__GetFloat_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          aqua2_simulation_interfaces__srv__GetFloat_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!aqua2_simulation_interfaces__srv__GetFloat_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
