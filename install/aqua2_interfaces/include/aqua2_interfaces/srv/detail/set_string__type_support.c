...
#include <stddef.h>
#include "aqua2_interfaces/srv/detail/set_string__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  aqua2_interfaces__srv__SetString_Request__init(message_memory);
}

void SetString_Request__rosidl_typesupport_introspection_c__SetString_Request_fini_function(void * message_memory)
{
  aqua2_interfaces__srv__SetString_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetString_Request__rosidl_typesupport_introspection_c__SetString_Request_message_member_array[1] = {
  {
    ...
    offsetof(aqua2_interfaces__srv__SetString_Request, value),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers SetString_Request__rosidl_typesupport_introspection_c__SetString_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(aqua2_interfaces__srv__SetString_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_interfaces, srv, SetString_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  aqua2_interfaces__srv__SetString_Response__init(message_memory);
}

void SetString_Response__rosidl_typesupport_introspection_c__SetString_Response_fini_function(void * message_memory)
{
  aqua2_interfaces__srv__SetString_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetString_Response__rosidl_typesupport_introspection_c__SetString_Response_message_member_array[1] = {
  {
    "msg",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_STRING,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aqua2_interfaces__srv__SetString_Response, msg),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetString_Response__rosidl_typesupport_introspection_c__SetString_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(aqua2_interfaces__srv__SetString_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_aqua2_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_interfaces, srv, SetString_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_service_members = {
  "aqua2_interfaces__srv",  // service namespace
  "SetString",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_Request_message_type_support_handle,
  NULL  // response message
  // aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_Response_message_type_support_handle
};

static rosidl_service_type_support_t aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_service_type_support_handle = {
  0,
  &aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_interfaces, srv, SetString)() {
  if (!aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_service_type_support_handle.typesupport_identifier) {
    aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_interfaces, srv, SetString_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua2_interfaces, srv, SetString_Response)()->data;
  }

  return &aqua2_interfaces__srv__detail__set_string__rosidl_typesupport_introspection_c__SetString_service_type_support_handle;
}
